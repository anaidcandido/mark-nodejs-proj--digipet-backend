...
describe("ignoreDigipet", () => {
  it("decreases digipet discipline, happiness and nutrition by 10", () => {
    // setup
    setDigipet(INITIAL_DIGIPET);
    expect(getDigipet()).toStrictEqual(INITIAL_DIGIPET);
  ...
  it("cannot decrease happiness, nutrition and discipline below 0", () => {
    // setup
    setDigipet({ happiness: 0, nutrition: 5, discipline: 10 });
